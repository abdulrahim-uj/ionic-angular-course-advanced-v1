...
export class RecipieDetailPage implements OnInit {
  ...
  ngOnInit() {
    this.activatedRoute.paramMap.subscribe(paramMapObj => {
      ...
      console.log("This is ngOnInit from DetailsPage");
    });
  }

  ionViewWillEnter() {
    console.log("This is ionViewWillEnter from DetailsPage");
  }

  ionViewDidEnter() {
    console.log("This is ionViewDidEnter from DetailsPage");
  }

  ionViewWillLeave() {
    console.log("This is ionViewWillLeave from DetailsPage");
  }

  ionViewDidLeave() {
    console.log("This is ionViewDidLeave from DetailsPage");
  }

  ngOnDestroy() {
    console.log("This is ngOnDestroy from DetailsPage");
  }
